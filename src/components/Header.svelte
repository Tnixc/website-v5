...
<header class="flex flex-col flex-wrap justify-end md:flex-row md:justify-between">
  <nav class="flex py-2" style="animation-duration: 500ms; animation-delay: 100ms;">
  ...
  <div class="flex flex-col md:flex-row pl-2">
    {#each headerLinks as element, i}
      <div class="flex items-baseline" style="animation-duration: 500ms; animation-delay: {i * 200}ms ">
        {#if element.action == "open"}
          <a href={element.value} class="{element.class} group relative py-2 hover:underline"
            >{element.text}
            <span
        ...
        {#if element.action == "copy"}
          <button on:click={() => copy(element.value)} class="{element.class} group relative py-2 hover:underline"
            >{element.text}
            <span
