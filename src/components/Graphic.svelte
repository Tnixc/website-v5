<script lang="ts">
  ...
  async function getLatest() {
    const res = await fetch("https://api.github.com/repos/tnixc/website-v5/git/refs/heads/main");
...
<div class="max-w-screen absolute bottom-10 right-0 -z-50">
  <svg width="327" height="327" viewBox="0 0 327 327" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="163.663" cy="163.663" r="162.837" stroke="black" stroke-opacity="0.2" />
  </svg>
  ...
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg">
    <circle cx="191.663" cy="191.663" r="190.626" stroke="black" stroke-opacity="0.2" stroke-dasharray="16 8" />
  </svg>
  ...
  <div class="absolute -left-full bottom-16 bg-black/10 p-2 text-sm opacity-40">
    <a href="https://github.com/tnixc/website-v5" class="select-none hover:underline">
      {latest}
    </a>
  </div>
</div>
