    ...
    <div class="flex flex-wrap gap-4 border border-black p-2">
      ...
      <ul
        ...
        {#each data.posts as post}
          <li class="w-full max-w-[min(90vw,70ch)] border border-black/20 transition-all duration-200 hover:shadow-md">
...
<style>
  main::after {
    ...
    z-index: 999;
    pointer-events: none;
    background: linear-gradient(-25deg, #00000022, transparent, #00000033, #ffffff44, #00000044, #ffffff99, #00000077);
    filter: blur(10px);
    opacity: 0.5;
  }
</style>
