  ...
  Info: [
    {
      ...
      value:
        "Hiking, traveling, reading books, programming, configuring, listening to music(jpop), graphic and ui design, urban design and transit, typography, open source, art, IKEA, mechanical keyboards, Robots(FRC), video games, webdev, crafting beautiful ui",
    },
  ],
};
