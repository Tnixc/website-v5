...
<div class="p-2 text-white" id="window-content">
  <div class="flex items-center justify-between">
    <button on:click={() => close()} class="flex gap-2 border border-white/20 p-2 cursor-pointer">
      <img src={openicon} height="24" width="24" alt="open icon" class="-scale-y-100 hue-rotate-180 invert" />
      Close</button>
    <h1 class="">Projects</h1>
    <a href="https://github.com/Tnixc" class="flex gap-2 border border-white/20 p-2">
      <img src={githubicon} height="24" width="24" alt="open icon" class="hue-rotate-180 invert" />
      My Github</a>
  </div>
    ...
    {#each projects as project}
      <div class="card flex flex-col gap-1 border border-white/20 p-2">
        ...
        <div class="flex flex-wrap items-center gap-2">
          <img src={githubicon} height="24" width="24" alt="open icon" class="hue-rotate-180 invert" />
          <a href={project.github} class="break-all text-blue-400 hover:underline">
            {project.github}
          </a>
          <div class="flex-grow" />
          {#if project.tags}
